...
public class ProfileFragment extends Fragment implements View.OnClickListener {
    ...
    private RecyclerView rvPostImages;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (this.getArguments() != null) otherUserId = this.getArguments().getString("UserId");
    ...
    private void setUpRecycler() {
        personalPostAdapter = new PersonalPostAdapter(postList, getActivity());
        rvPostImages.setLayoutManager(new GridLayoutManager(getActivity(), 4));
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            if (task.getResult().exists()) {
                                ...
                                Glide.with(getActivity()).setDefaultRequestOptions(placeHolderRequest).load(imageUrl).into(profileImage);
                            ...
                            String error = task.getException().getMessage();
                            Toast.makeText(getActivity(), "FireStore Retrieve Error: " + error,
